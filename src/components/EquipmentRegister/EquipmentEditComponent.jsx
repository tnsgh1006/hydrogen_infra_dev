...
function EquipmentEditComponent() {
        ...
        <div className={`station-regist-station-add full-width}`}>
          ...
          <div className="station-regist-station-add-input">
            ...
            <div className="button-edit">
              <button className="button-submit-form add-equipm cancel">
                취소하기
              </button>
              <button className="button-submit-form add-equipm">
                등록하기
              </button>
            </div>
          </div>
...
export default EquipmentEditComponent;
