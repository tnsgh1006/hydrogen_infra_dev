...
var tsApiUtils$1 = require('ts-api-utils');
...
function createRuleUsingFunction(name, meta, defaultOptions, createFunction) {
    const ruleCreator = eslintUtils.RuleCreator((ruleName) => `https://github.com/eslint-functional/eslint-plugin-functional/blob/v6.0.0/docs/rules/${ruleName}.md`);
            ...
            if (type !== null) {
                ...
                if (ts !== undefined &&
                    ...
                    if (returnStatements.every((statement) => statement.expression !== undefined &&
                        tsApiUtils$1.isThisKeyword(statement.expression))) {
                        return {
                            context,
                            descriptors: [],
                        };
