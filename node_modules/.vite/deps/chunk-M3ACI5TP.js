...
import {
  ...
  useList,
  useListItem
} from "./chunk-DPGZQUFH.js";
import {
  Transition_default,
  useForkRef_default
} from "./chunk-B4FVKH6C.js";
import {
  require_react_dom
...
var Portal = React21.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React21.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React41.Fragment, {
...
var Slider = React43.forwardRef(function Slider2(props, forwardedRef) {
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React44.useRef();
  React44.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React44.useCallback(() => {
...
var Snackbar = React45.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
function useTabs(parameters) {
  ...
  const onSelected = React50.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null || onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React50.useRef(() => void 0);
  const getTabPanelId = React50.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React50.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React50.useCallback((lookupFunction) => {
...
var TabsContext = React51.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React51.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React53.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React54.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React55.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React56.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React56.useCallback((tabValue) => {
  ...
  const handleChange = React56.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React56.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React56.useCallback((item) => {
  ...
  const contextValue = React56.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React58.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
function useTab(parameters) {
  ...
  const tabRef = React59.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React59.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var Tab = React60.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var TextareaAutosize = React61.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React62.useRef(false);
  const firstFocus = React62.useRef(true);
  const inputRef = React62.useRef(null);
  const listboxRef = React62.useRef(null);
  const [anchorEl, setAnchorEl] = React62.useState(null);
  const [focusedTag, setFocusedTag] = React62.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React62.useRef(defaultHighlighted);
  ...
  const resetInputValue = React62.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React62.useState(true);
  ...
  const syncHighlightedIndex = React62.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React62.useRef(false);
...
var Modal3 = React65.forwardRef(function Modal4(inProps, ref) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-M3ACI5TP.js.map
